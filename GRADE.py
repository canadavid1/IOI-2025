...
import shutil
import io
# TODO: implement Communication tasks
# these can usually be verified easily locally, so won't bother yet
...
if not os.path.exists(CHECKOUT):
    if CHECKER is not None and os.path.exists(CHECKER):
        r,t = run_timer("g++","--std=c++23","-O2","-static",CHECKER,"-o",CHECKOUT)
